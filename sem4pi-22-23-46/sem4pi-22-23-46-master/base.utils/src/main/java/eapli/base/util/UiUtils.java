...
public class UiUtils {
    ...
    static public boolean confirm(String message) {
        String input;
        do {
            input = UiUtils.readLineFromConsole(message);
    ...
    static public Object selectsObject(List list)
    {
        ...
        do
        {
            input = UiUtils.readLineFromConsole("Type your option: ");
    ...
    static public Calendar selectDate(String inputDate){
    ...
    static public LocalTime selectTime(String inputTime){
    ...
    static public String readFile (String filePath) throws FileNotFoundException {
