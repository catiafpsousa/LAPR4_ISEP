...
public class SBPCreatePostItRequest extends Thread{
    ...
    public SBPCreatePostItRequest(SBPMessage message, SystemUser user) {
    ...
    public void run() {
        try {
            ...
            controller.createPostIt(receivedBoard, receivedCell, receivedContent, user);
    ...
    private synchronized SBPMessage buildResponse() {
        String responseMessage = "Save PostIt successfully";
    ...
    public synchronized SBPMessage createPostItMessageResponse(){
        return this.result;
    }
