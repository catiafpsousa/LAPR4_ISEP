...
public class ListBoardsArchiveBoardRequest extends Thread{

    private SBPMessage result;
    private ArchiveBoardController controller;
    private SystemUser user;

    public ListBoardsArchiveBoardRequest(ArchiveBoardController controller, SystemUser user) {
    ...
    public void run() {
        try{
            List<SharedBoard> sharedBoardList = (List) controller.allBoardsOwnedByUser(user);
