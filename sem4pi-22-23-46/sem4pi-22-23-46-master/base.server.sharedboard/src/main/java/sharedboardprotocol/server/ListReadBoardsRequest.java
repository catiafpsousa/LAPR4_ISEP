...
public class ListReadBoardsRequest extends Thread {
    private SBPMessage result;
    private ServerViewBoardHistoryController controller;
    private SystemUser user;

    public ListReadBoardsRequest(ServerViewBoardHistoryController controller, SystemUser user) {
    ...
    public void run() {
        try {
            List<SharedBoard> sharedBoardList = (List) controller.sharedBoardsWithReadPermission(user);
