...
public class ListBoardsRestoreBoardRequest extends Thread {

    private SBPMessage result;
    private RestoreBoardController controller;
    private SystemUser user;

    public ListBoardsRestoreBoardRequest(RestoreBoardController controller, SystemUser user) {
    ...
    public void run() {
        try{
            List<SharedBoard> sharedBoardList = (List) controller.allBoardsArchivedOwnedByUser(this.user);
