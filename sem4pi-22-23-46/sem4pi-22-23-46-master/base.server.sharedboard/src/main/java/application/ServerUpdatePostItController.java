...
@UseCaseController
public class ServerUpdatePostItController {
     ...
     */
    @Transactional
    public boolean updatePostItContent(SharedBoard board, Cell cell, PostIt postIt, Content newContent, SystemUser user) {
        this.owner = user;
